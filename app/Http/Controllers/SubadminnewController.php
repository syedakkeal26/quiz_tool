...
class SubadminnewController extends Controller
{
    /**
    ...
    {
        $subadmin=User::where('role','subadminnew')->paginate(5);
        return view('subadminnew.subadminnew',compact('subadmin'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('subadminnew.edit_subadminnew',compact('subadmin'));
    }
    ...
    public function destroy(Request $request,$id)
    {
        ...
        $subadmin=User::where('role','subadminnew')->get();
        $msg='You Removed '.$emp_name.' From Sub-Admin';
        Session::put('messages', $msg);
     //    Session::put('message','Records Deleted successfully');
        return redirect()->route('subadminnew.index')->with(compact('subadmin'));
    }

    public function regformapis(Request $request)
    {
