...
#signin-form .remember{ margin-bottom:10px; float:left; width:120px;}
...
.forgot_form a:hover { color:#1495C7; text-decoration:underline;}
...
<body id="signin">
	<div id="signin-container">
      ...
      <div id="signin-form">
            ...
            <div class="remember">
  					<input type="checkbox"  name="remember"  id="remember" value="1" class="checkbox_remember" > 
        			<p>Remember me</p>
  				</div>
