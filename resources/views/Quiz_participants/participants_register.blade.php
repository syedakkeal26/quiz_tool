...
#signin-form .forgot a{ color:#1495c7;}
...
function Chk_Emp(frm)
{
	document.getElementById("user_alert").innerHTML="";
	if(frm.login_user.value == "")
	{
		document.getElementById("user_alert").innerHTML="<div class='it-validates-flag'>Required</div>";
		frm.login_user.focus();
		return false;
	}
   var emailcheck  = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
	if(emailcheck.test(frm.login_user.value)== false)
	{
		document.getElementById("user_alert").innerHTML="<div class='it-validates-flag'>Invalid</div>";
		frm.login_user.focus();
		return false;
	}
   ...
   if(frm.login_pwd.value == "")
	{
		document.getElementById("pass_alert").innerHTML="<div class='it-validates-flag'>Required</div>";
		frm.login_pwd.focus();
		return false;
	}
}
<!--SCRIPT FOR LOGIN FORM VALIDATION END-->
<!--HIDE  SCRIPT FOR MESSAGE START-->
function timedMsg()
{
	var t=setTimeout("document.getElementById('myMsg').style.display='none';",4000);
}
<!--HIDE  SCRIPT FOR MESSAGE END-->
<!-- JAVASCRIPT CODE END -->
</script>
</head>
<body id="signin">
	<div id="signin-container">
    	...
    	<h2 id="company-logo">
    	<a href="index.php">
    	    	<img src="{{ URL::asset('assets/dist/img/colan-logo.png') }}"  border="0" style="margin-top:107px;"/>
    	    	</a></h2>
            </div>
            <div class="col-6">
      ...
      <div id="signin-form">
   		  <ul>
          <li style="position:relative"><label>Name</label>
          ...
          <li style="position:relative"><label>Email</label>
            ...
            @enderror
             <div id="user_alert"></div>
                ...
                <input id="mobile" type="text"  class="@error('phone_no') is-invalid @enderror" name="phone_no" value="{{ old('phone_no') }}" required autocomplete="phone_no" >
                @error('phone_no')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      @enderror
              ...
              <div class="forgot">
                <a href="{{ route('participantLoginView',$slug) }}" class="text-center">Already Registered? Login Here !</a>
              </div>    <br>
