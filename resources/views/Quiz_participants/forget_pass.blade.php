	...
	<div id="signin-container">
    	...
    	<a href="index.php">
            ...
            <div class="col-6">
              ...
              @endif
              <form action="{{route('participantForget')}}" method="post">
                @csrf         
      ...
      <div id="signin-form">
   		  ...
   		  <ul>
                ...
                <input id="email" type="text" name="email" value="{{ $getEmail }}"  autocomplete="mobile" autofocus required readonly>
                
            		 <div id="user_alert"></div>
            	 </li>
                <li style="position:relative"><label>OTP</label>
                  <input id="otp" type="text" name="otp" autocomplete="current-password" required>
