...
<div class="container-fluid">
    ...
    <div class="col-12">
        ...
        <div class="card-header">
            <h3 class="card-title">Admin Details listed Below</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <tbody>
                ...
                @foreach($subadmin as $data)
                    ...
                    <td>
                        ...
                        <a href="{{route('subadmin.edit',$id)}}"><i class='fas fa-pen'></a></td>
                    <td>
                        <form action="{{route('subadmin.destroy',$id)}}"  method="POST">
                        @csrf
                        @method('DELETE')
